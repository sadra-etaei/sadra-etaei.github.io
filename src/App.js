...
function App() {
  ...
  function get() {
    ...
    data.map(pro => setProjects(prev => [...prev, <Project link={pro.link} name={pro.name} src={pro.src} />]))
  }
  function changeMode() {
    ...
    <main>
        ...
        <div id='about' className='about'>
          <div className='info'>
            ...
            <p> I am a 16 year old iranian  web developer and proffesional tennis player  based in Urmia / Iran
              ...
              I`m a math major and I`m also fluent in english , turkish and german .</p>
          </div>
      ...
      <div lang="fa-IR" className="fa" style={style3} >
        ...
        <div id='about2' className='about'>
          <div className='info'>
            <h1>درباره من </h1>
            <p>  من صدرا اعطایی برنامه نویس , توسعه دهنده وب و تنیسور متولد 1386 هستم و چند سالی هست که برنامه نویسی می کنم و الان یک سال هست که به صورت نخصصی برنامه نویس وب می کنم</p>
          </div>
          <img id='personal' src={img1} alt="" />
        </div>
        <div id='skills' className='skills'>
